...
import ImpiantoComponent from 'src/app/modules/impianto/components/impianto/impianto.component';
...
export default class AppLayoutComponent {
  ...
  section!: '' | 'utenti' | 'impianti' | 'anagrafica' | 'profilo';
  ...
  setSection() {
    ...
    } else if(this.router.url.includes('gestionale/impianti/getall')) {
      this.section = 'impianti';
      console.log(this.section);
    } else if(this.router.url.includes('gestionale/anagrafica/getall')) {
      this.section = 'anagrafica';
      console.log(this.section);
    } else if(this.router.url.includes('gestionale/profilo')) {
      this.section = 'anagrafica';
      console.log(this.section);
    }
    else this.section = '';
  ...
  onButtonClicks(): void {
    ...
    // Puoi eseguire altre azioni quando il bottone viene cliccato
  }
}
