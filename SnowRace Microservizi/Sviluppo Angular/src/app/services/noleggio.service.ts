...
export class NoleggioService {
  ...
  deleteNoleggio(id: number): Observable<any> {
    ...
    let url = `${this.baseUrl}noleggio/deleteNoleggio?id=${id}`;
    console.log(url);
  ...
  insertNoleggio(body: any): Observable<any> {
    ...
    if (this.loginService.getUtenteSessione().usertype === "user"){
      body.username = this.loginService.getUtenteSessione().username;}
    let url = `${this.baseUrl}noleggio/insertNoleggio`;
  ...
  modificaNoleggio(payload: any): Observable<any> {
    ...
    if (this.loginService.getUtenteSessione().usertype === "user"){
      payload.username = this.loginService.getUtenteSessione().username;}
    let url = `${this.baseUrl}noleggio/updateNoleggio`;
    return this.http.put(url, payload);
  }

  readNoleggio(id: number): Observable<any> {
    let url = `${this.baseUrl}noleggio/readNoleggio?id=${id}`;
