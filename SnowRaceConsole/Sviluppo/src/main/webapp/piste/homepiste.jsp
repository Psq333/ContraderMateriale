...
<nav class="navbar">
     ...
     <h1> Piste dell impianto NOMEIMPIANTO </h1>
...
<form class="create-form" action="PisteServlet?mode=insert" method="post">
	...
	<div class="form-group">
		...
		<input type="text" id="idpista" name="idpista" placeholder="Inserisci l'id della pista" required>
	</div>

	<div class="form-group">
		<label for="idimpianto">ID Impianto </label>
		<input type="text" id="idimpianto" name="idimpianto" placeholder="Inserisci l'id dell'impianto" required>
	</div>
