         ...
         <form class="create-form">
                <h1> Menu Utente</h1>
                    <div class="button-wrapper">
                        <button type="button" onclick="window.location.href='ImpiantoServlet?mode=get_all'">Nuova Prenotazione</button>
                    </div>
                    <div class="button-wrapper">
                        <button type="button" onclick="window.location.href='AttrezzatureServlet?mode=getalluser'">Nuovo Noleggio</button>
                    </div>
                    <div class="button-wrapper">
                        <button type="button" onclick="window.location.href='PrenotazioniServlet?mode=search'">Gestisci prenotazioni</button>
                    </div>
         </form>
    </div>
