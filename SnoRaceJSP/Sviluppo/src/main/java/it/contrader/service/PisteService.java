...
public class PisteService {
    ...
    public List<PisteDTO> getAllImpianti(String username){
        return pisteConverter.toDTOList(pisteDAO.getAll(username));
    }
    ...
    public List<PisteDTO> getAll(String username){return pisteConverter.toDTOList(pisteDAO.getAll(username));}
}
