...
public class AttrezzatureDAO {
    ...
    private final String QUERY_ALL = "SELECT * FROM attrezzatura";

    private final String QUERY_CREATE = "INSERT INTO attrezzatura (prezzo,descrizione,nome,idimpianto) VALUES (?,?,?,?)";

    private final String QUERY_READ = "SELECT * FROM attrezzatura WHERE idattrezzatura=?";

    private final String QUERY_UPDATE = "UPDATE attrezzatura SET prezzo=?, descrizione=?, nome=?, idimpianto =? WHERE idattrezzatura=?";

    private final String QUERY_DELETE = "DELETE FROM attrezzatura WHERE idattrezzatura=?";
