...
<body class="text-center">
	...
	<form class="login" action="/user/register" method="get">
		<button class="btn btn-lg btn-primary btn-block" onclick="window.location.href='/user/register'">Registrazione</button>
	</form>
