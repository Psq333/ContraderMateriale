...
<%@ include file="../css/navbar.jsp"%>
    <div>
        <%
        List<PistaDTO> list = (List<PistaDTO>) request.getAttribute("pisteAdmin");
        %>
        <div class="row">
            <div class="col-xl-6">
        ...
        <form class="create-form" action="/pista/insert" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nome" name="nomePista" placeholder="Inserisci nome Pista..." required>
            </div>
            <div class="form-group">
                <label for="difficolta">Difficoltà </label>
                <input type="text" id="difficolta" name="difficoltaPista" placeholder="Inserisci difficoltà Pista..." required>
            </div>
            <div class="form-group">
                <label for="prezzo">Prezzo </label>
                <input type="number" id="prezzo" name="prezzoPista" placeholder="Inserisci prezzo Pista..." required>
            </div>
            <div class="form-group">
                <label for="prenMax">Prenotazioni Massime </label>
                <input type="number" id="prenMax" name="prenMax" placeholder="Inserisci numero prenotazioni massime..." required>
            </div>
